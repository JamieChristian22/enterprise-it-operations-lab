# INC-260713: Cannot reach internal website
...
| Opened | 2026-07-13 09:31 |
| Status | Solved |
| Time Spent | 39 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **cannot reach internal website**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.
...
## Root Cause
Incorrect DNS server from static adapter settings.

## Resolution
Restored DHCP DNS, flushed cache, verified name resolution.
