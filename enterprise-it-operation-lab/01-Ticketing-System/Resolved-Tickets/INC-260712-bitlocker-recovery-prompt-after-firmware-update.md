# INC-260712: BitLocker recovery prompt after firmware update
...
| Type | Incident |
| Priority | P2 |
| Assigned Queue | Security Review |
| Assigned Agent | Jamie Christian |
| Opened | 2026-07-12 09:24 |
| Status | Solved |
| Time Spent | 44 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **bitlocker recovery prompt after firmware update**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.
...
## Root Cause
TPM measurement changed after BIOS update.

## Resolution
Verified device ownership, used escrowed recovery key, suspended and resumed protection.
...
Hello Jordan Ellis, your issue has been resolved. I verified the fix with you and confirmed that the affected workflow is functioning normally. Please reply to this ticket if the problem returns.
