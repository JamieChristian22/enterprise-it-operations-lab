# INC-260718: Wi-Fi disconnects in conference room
...
| Opened | 2026-07-18 09:06 |
| Status | Solved |
| Time Spent | 110 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **wi-fi disconnects in conference room**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.

## Business Impact
The impact was limited to multiple departments operations. Priority was assigned using the documented impact-versus-urgency matrix.
...
## Root Cause
Access point channel interference.

## Resolution
Changed channel plan, rebooted AP, monitored stable connections.
