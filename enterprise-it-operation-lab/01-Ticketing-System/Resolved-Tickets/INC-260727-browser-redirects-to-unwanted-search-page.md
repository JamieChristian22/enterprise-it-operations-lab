# INC-260727: Browser redirects to unwanted search page
...
| Opened | 2026-07-27 09:09 |
| Status | Solved |
| Time Spent | 55 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **browser redirects to unwanted search page**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.
...
## Resolution
Disconnected network, removed extension, scanned device, reset browser, changed credentials.
