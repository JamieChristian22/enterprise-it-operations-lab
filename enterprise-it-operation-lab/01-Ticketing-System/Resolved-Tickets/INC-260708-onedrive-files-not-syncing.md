# INC-260708: OneDrive files not syncing
...
| Opened | 2026-07-08 09:56 |
| Status | Solved |
| Time Spent | 49 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **onedrive files not syncing**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.
...
## Root Cause
Invalid filename and paused client.

## Resolution
Renamed file, resumed sync, reset client, verified cloud status.
