# INC-260719: Excel add-in crashes at launch
...
| Opened | 2026-07-19 09:13 |
| Status | Solved |
| Time Spent | 37 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **excel add-in crashes at launch**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.
...
## Resolution
Disabled old add-in, installed supported version, verified workbook workflow.
