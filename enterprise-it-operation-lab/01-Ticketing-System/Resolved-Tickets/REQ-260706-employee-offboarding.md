# REQ-260706: Employee offboarding
...
| Priority | P2 |
| Assigned Queue | Employee Lifecycle |
| Assigned Agent | Jamie Christian |
| Opened | 2026-07-06 09:42 |
| Status | Solved |
| Time Spent | 58 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **employee offboarding**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.

## Business Impact
The impact was limited to operations operations. Priority was assigned using the documented impact-versus-urgency matrix.
...
## Resolution
Disabled account, revoked sessions, converted mailbox, transferred files, recovered device.
