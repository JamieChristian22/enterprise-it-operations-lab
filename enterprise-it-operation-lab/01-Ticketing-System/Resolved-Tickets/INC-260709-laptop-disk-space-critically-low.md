# INC-260709: Laptop disk space critically low
...
| Type | Incident |
| Priority | P3 |
| Assigned Queue | Endpoint Support |
| Assigned Agent | Jamie Christian |
| Opened | 2026-07-09 09:03 |
| Status | Solved |
| Time Spent | 52 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **laptop disk space critically low**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.
...
## Root Cause
Large temporary update cache and downloads.

## Resolution
Removed temporary files, archived downloads, enabled Storage Sense.
