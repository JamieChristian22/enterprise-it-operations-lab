# INC-260716: Account disabled unexpectedly

## Ticket Record

| Field | Value |
|---|---|
| Requester | Riley Bennett |
| Department | Finance |
| Device | LAP-FIN-004 |
| Type | Incident |
| Priority | P2 |
...
| Opened | 2026-07-16 09:52 |
| Status | Solved |
| Time Spent | 29 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **account disabled unexpectedly**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.

## Business Impact
The impact was limited to finance operations. Priority was assigned using the documented impact-versus-urgency matrix.
...
## Root Cause
Account expiration date set during temporary assignment.

## Resolution
Confirmed employment, removed expiration, enabled account, documented approval.
...
Hello Riley Bennett, your issue has been resolved. I verified the fix with you and confirmed that the affected workflow is functioning normally. Please reply to this ticket if the problem returns.
