# INC-260726: Remote desktop connection denied
...
| Opened | 2026-07-26 09:02 |
| Status | Solved |
| Time Spent | 30 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **remote desktop connection denied**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.

## Business Impact
The impact was limited to it operations. Priority was assigned using the documented impact-versus-urgency matrix.
...
## Root Cause
User missing Remote Desktop Users membership.

## Resolution
Confirmed authorization, added group membership, verified connection.
