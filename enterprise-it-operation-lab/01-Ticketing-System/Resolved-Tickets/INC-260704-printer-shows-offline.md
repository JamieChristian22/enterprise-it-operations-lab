# INC-260704: Printer shows offline
...
| Opened | 2026-07-04 09:28 |
| Status | Solved |
| Time Spent | 35 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **printer shows offline**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.
...
## Root Cause
Stale TCP/IP port after printer DHCP change.

## Resolution
Updated port to reserved IP, restarted spooler, printed test page.
