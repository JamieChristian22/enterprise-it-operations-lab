# REQ-260723: New project folder access
...
| Opened | 2026-07-23 09:41 |
| Status | Solved |
| Time Spent | 24 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **new project folder access**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.
...
## Root Cause
Approved role-based access request.

## Resolution
Added user to project security group and verified read/write permissions.
