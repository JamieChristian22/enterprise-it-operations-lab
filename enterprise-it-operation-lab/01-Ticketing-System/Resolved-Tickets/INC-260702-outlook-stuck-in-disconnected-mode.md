# INC-260702: Outlook stuck in disconnected mode
...
| Opened | 2026-07-02 09:14 |
| Status | Solved |
| Time Spent | 42 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **outlook stuck in disconnected mode**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.
...
## Root Cause
Corrupted Outlook profile after update.

## Resolution
Created new Outlook profile, re-added mailbox, confirmed send/receive.
