# INC-260728: VoIP headset has no audio

## Ticket Record

| Field | Value |
|---|---|
| Requester | Parker Hayes |
| Department | Customer Success |
| Device | LAP-CS-008 |
| Type | Incident |
| Priority | P3 |
| Assigned Queue | Hardware |
| Assigned Agent | Jamie Christian |
| Opened | 2026-07-28 09:16 |
| Status | Solved |
| Time Spent | 19 minutes |
| SLA | Met |

## User-Reported Problem
The requester reported **voip headset has no audio**. The issue affected normal work and required service-desk assistance. The user confirmed the affected device and described the last successful use.

## Business Impact
The impact was limited to customer success operations. Priority was assigned using the documented impact-versus-urgency matrix.
...
## Root Cause
Default output switched after Windows update.

## Resolution
Set headset as default communications device and verified call.
...
Hello Parker Hayes, your issue has been resolved. I verified the fix with you and confirmed that the affected workflow is functioning normally. Please reply to this ticket if the problem returns.
