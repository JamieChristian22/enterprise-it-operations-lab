...
## Purpose
Provides a repeatable, auditable method to perform **get networkconfiguration** in the CTS lab.
...
## Usage
```powershell
Get-Help .\15-Get-NetworkConfiguration.ps1 -Full
.\15-Get-NetworkConfiguration.ps1 -WhatIf
```
