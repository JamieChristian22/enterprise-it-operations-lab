# Reset CTSUserPassword

## Purpose
Provides a repeatable, auditable method to perform **reset ctsuserpassword** in the CTS lab.
...
## Usage
```powershell
Get-Help .\04-Reset-CTSUserPassword.ps1 -Full
.\04-Reset-CTSUserPassword.ps1 -WhatIf
```
