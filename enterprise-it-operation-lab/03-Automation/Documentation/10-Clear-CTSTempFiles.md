...
## Purpose
Provides a repeatable, auditable method to perform **clear ctstempfiles** in the CTS lab.
...
## Usage
```powershell
Get-Help .\10-Clear-CTSTempFiles.ps1 -Full
.\10-Clear-CTSTempFiles.ps1 -WhatIf
```
