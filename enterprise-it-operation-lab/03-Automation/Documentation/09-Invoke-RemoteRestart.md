# Invoke RemoteRestart

## Purpose
Provides a repeatable, auditable method to perform **invoke remoterestart** in the CTS lab.
...
## Usage
```powershell
Get-Help .\09-Invoke-RemoteRestart.ps1 -Full
.\09-Invoke-RemoteRestart.ps1 -WhatIf
```
