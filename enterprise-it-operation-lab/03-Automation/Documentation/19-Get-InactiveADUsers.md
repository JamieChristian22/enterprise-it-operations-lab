...
## Purpose
Provides a repeatable, auditable method to perform **get inactiveadusers** in the CTS lab.
...
## Usage
```powershell
Get-Help .\19-Get-InactiveADUsers.ps1 -Full
.\19-Get-InactiveADUsers.ps1 -WhatIf
```
