...
## Purpose
Provides a repeatable, auditable method to perform **get systeminventory** in the CTS lab.
...
## Usage
```powershell
Get-Help .\13-Get-SystemInventory.ps1 -Full
.\13-Get-SystemInventory.ps1 -WhatIf
```
