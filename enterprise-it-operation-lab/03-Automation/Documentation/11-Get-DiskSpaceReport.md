...
## Purpose
Provides a repeatable, auditable method to perform **get diskspacereport** in the CTS lab.
...
## Usage
```powershell
Get-Help .\11-Get-DiskSpaceReport.ps1 -Full
.\11-Get-DiskSpaceReport.ps1 -WhatIf
```
