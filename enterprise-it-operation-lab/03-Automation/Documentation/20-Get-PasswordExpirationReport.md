# Get PasswordExpirationReport

## Purpose
Provides a repeatable, auditable method to perform **get passwordexpirationreport** in the CTS lab.
...
## Usage
```powershell
Get-Help .\20-Get-PasswordExpirationReport.ps1 -Full
.\20-Get-PasswordExpirationReport.ps1 -WhatIf
```
