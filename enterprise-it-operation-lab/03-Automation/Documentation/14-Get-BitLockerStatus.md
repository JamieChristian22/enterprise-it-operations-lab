...
## Purpose
Provides a repeatable, auditable method to perform **get bitlockerstatus** in the CTS lab.
...
## Usage
```powershell
Get-Help .\14-Get-BitLockerStatus.ps1 -Full
.\14-Get-BitLockerStatus.ps1 -WhatIf
```
