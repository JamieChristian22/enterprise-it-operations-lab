...
## Purpose
Provides a repeatable, auditable method to perform **rename ctscomputer** in the CTS lab.
...
## Usage
```powershell
Get-Help .\08-Rename-CTSComputer.ps1 -Full
.\08-Rename-CTSComputer.ps1 -WhatIf
```
