# KB-009: Troubleshoot Windows Service Failures
...
Provide a repeatable, auditable procedure to diagnose and resolve windows service failures in the Contoso Systems Administration Lab.
...
- Startup returns error 1053, 1067, or 1079
- Dependent applications are unavailable


## Likely causes

- Invalid service account or expired password
- Missing dependency or port conflict
- Corrupt configuration or binary path
...
```text
Get-WinEvent -LogName System -MaxEvents 50 | Where-Object Id -in 7000,7001,7009,7011,7031,7034
```
...
- Startup type matches design
- Dependent application health check passes
