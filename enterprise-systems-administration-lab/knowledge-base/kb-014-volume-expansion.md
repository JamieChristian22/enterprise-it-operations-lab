# KB-014: Expand a Windows Data Volume
...
Provide a repeatable, auditable procedure to diagnose and resolve a windows data volume in the Contoso Systems Administration Lab.
...
- A supported volume is near capacity
- Additional virtual disk space has been allocated
- Unallocated space is available after the target partition
...
- Get-Volume shows the new capacity
- File-system check is clean
- Application read/write test succeeds
