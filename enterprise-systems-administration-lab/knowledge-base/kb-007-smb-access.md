# KB-007: Troubleshoot SMB Share Access
...
Provide a repeatable, auditable procedure to diagnose and resolve smb share access in the Contoso Systems Administration Lab.
...
- UNC path cannot be opened
- Credential prompts repeat
- Access works locally but not over the network
...
- DNS, Kerberos, or stale session issue
...
- Open \FS01\Finance using the user account
- Create and delete a permitted test file
- Confirm denied operations remain denied
