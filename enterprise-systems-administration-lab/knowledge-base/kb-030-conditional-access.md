# KB-030: Troubleshoot Microsoft Entra Conditional Access
...
Provide a repeatable, auditable procedure to diagnose and resolve microsoft entra conditional access in the Contoso Systems Administration Lab.
...
- Sign-in is blocked unexpectedly
- MFA is required in an unintended scenario
- A policy does not apply to a target user


## Likely causes

- Assignment, exclusion, or condition mismatch
- Device compliance or location failure
- Policy conflict or authentication-strength requirement
...
- Sign-in result matches policy intent
- Break-glass accounts remain excluded and monitored
- Policy is tested in report-only before enforcement
