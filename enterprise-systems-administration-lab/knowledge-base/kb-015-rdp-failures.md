# KB-015: Troubleshoot Remote Desktop Connection Failures
...
Provide a repeatable, auditable procedure to diagnose and resolve remote desktop connection failures in the Contoso Systems Administration Lab.
...
- Authentication succeeds then disconnects
- Only specific users cannot connect


## Likely causes

- TCP 3389 blocked or service stopped
- NLA, certificate, or licensing issue
- User lacks Remote Desktop Users permission
...
- Authorized user completes an RDP session
- Unauthorized user remains blocked
- No recurring terminal-services error appears
