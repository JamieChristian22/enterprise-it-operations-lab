# KB-024: Resolve Microsoft 365 Licensing Issues
...
Provide a repeatable, auditable procedure to diagnose and resolve resolve microsoft 365 licensing issues in the Contoso Systems Administration Lab.
...
- User cannot access a licensed service
- License assignment shows a conflict
...
- Usage-location or group-based licensing error
- Conflicting service-plan assignment
...
```text
Get-MgUser -UserId jcarter@contoso.com -Property UsageLocation
```
...
- Required service plans show Success
- User signs into the affected service
- License inventory and ticket notes are updated
