# KB-020: Troubleshoot and Grant Linux sudo Access

| Field | Value |
|---|---|
| Service | Linux / Security |
...
Provide a repeatable, auditable procedure to diagnose and resolve and grant linux sudo access in the Contoso Systems Administration Lab.
...
- User receives “not in the sudoers file”
- A permitted command is denied
- sudo policy differs between servers
...
- Command alias or host restriction mismatch
...
- A permitted command succeeds
- An unapproved command remains denied
...
```text
INC-260820 — Troubleshoot and Grant Linux sudo Access
...
Validation: sudo -l shows only approved commands; A permitted command succeeds.
