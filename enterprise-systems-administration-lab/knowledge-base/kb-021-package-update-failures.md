# KB-021: Troubleshoot Linux Package Update Failures

| Field | Value |
|---|---|
| Service | Linux / Patch Management |
...
Provide a repeatable, auditable procedure to diagnose and resolve linux package update failures in the Contoso Systems Administration Lab.
...
- apt or dnf update fails
- Repository metadata cannot be downloaded
- Package dependency resolution is broken


## Likely causes

- DNS/proxy/repository outage
- Stale package-manager lock
- Unsigned or expired repository key
...
- Repository metadata refresh succeeds
- Security updates install
- Package database reports no dependency errors
