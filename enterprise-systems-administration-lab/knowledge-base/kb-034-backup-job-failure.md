# KB-034: Troubleshoot Enterprise Backup Job Failures
...
Provide a repeatable, auditable procedure to diagnose and resolve enterprise backup job failures in the Contoso Systems Administration Lab.
...
- Scheduled backup failed or completed with warnings
- Recovery point is older than policy allows
- Repository or snapshot operation failed


## Likely causes

- Repository capacity or connectivity
- Expired credential or service failure
- VSS/snapshot or changed-block tracking problem
...
```text
Get-WinEvent -LogName Application | Where-Object ProviderName -eq VSS | Select -First 20
```
...
```text
Test-NetConnection backuprepo01 -Port 443
```
...
- Restore point appears in the catalog
- Backup age meets the RPO
