# KB-008: Recover Windows Print Spooler Failures
...
Provide a repeatable, auditable procedure to diagnose and resolve windows print spooler failures in the Contoso Systems Administration Lab.
...
- Printers disappear or installations fail
...
- Corrupt spool files
- Faulty print driver
- Service dependency or permissions problem
...
- Submit a test page
- Verify the queue clears
- Monitor the spooler for 15 minutes
