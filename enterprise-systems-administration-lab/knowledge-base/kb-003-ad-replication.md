# KB-003: Troubleshoot Active Directory Replication
...
Provide a repeatable, auditable procedure to diagnose and resolve active directory replication in the Contoso Systems Administration Lab.
...
- Users or groups differ between domain controllers
- GPO or password changes do not appear everywhere
- Directory Service replication alerts occur


## Likely causes

- DNS registration problems
- RPC/firewall interruption
- Lingering objects, time skew, or an offline domain controller
...
```text
Get-ADReplicationFailure -Target * -Scope Site
```
...
- Replication summary shows zero failures
- A test user attribute change reaches every DC
- Directory Service errors stop recurring
