# KB-019: Remediate Linux Disk and Inode Pressure
...
Provide a repeatable, auditable procedure to diagnose and resolve remediate linux disk and inode pressure in the Contoso Systems Administration Lab.
...
- Filesystem utilization exceeds 85%
- Application writes fail
- Inodes are exhausted despite available capacity


## Likely causes

- Log or container growth
- Deleted file remains open
- Large cache, backup, or temporary directory
...
- Filesystem and inode usage fall below threshold
- Application write test passes
- Growth source has a prevention action
