# KB-006: Troubleshoot NTFS Permission Issues

| Field | Value |
|---|---|
| Service | Windows File Services |
...
Provide a repeatable, auditable procedure to diagnose and resolve ntfs permission issues in the Contoso Systems Administration Lab.
...
- Access denied on a local or shared folder
- Users receive more access than intended
- Permissions differ after a move or inheritance change
...
- Explicit deny entry
- Broken inheritance or ownership
...
```text
icacls D:\Shares\Finance /inheritance:e
```
...
- Test access with the affected user
- Verify least-privilege group membership
- Confirm no unintended explicit grants remain
