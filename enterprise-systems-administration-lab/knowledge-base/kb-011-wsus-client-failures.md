# KB-011: Troubleshoot WSUS Client Reporting and Scan Failures
...
Provide a repeatable, auditable procedure to diagnose and resolve wsus client reporting and scan failures in the Contoso Systems Administration Lab.
...
- Device does not appear in WSUS
- Last status report is stale
- Scan reports 0x802440xx errors


## Likely causes

- Incorrect WSUS policy
- BITS/Windows Update service issue
- TLS, proxy, or content synchronization problem
...
- Client reports to WSUS
- A scan completes without error
- Needed updates display accurately
