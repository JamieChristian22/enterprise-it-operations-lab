# KB-031: Troubleshoot Hyper-V Virtual Machine Startup
...
Provide a repeatable, auditable procedure to diagnose and resolve hyper-v virtual machine startup in the Contoso Systems Administration Lab.
...
- VM fails to start
- VM is stuck in Starting or Saved state
- Hyper-V reports insufficient resources or configuration error


## Likely causes

- Storage path unavailable
- Memory, checkpoint, or permissions problem
- Virtual switch or configuration corruption
