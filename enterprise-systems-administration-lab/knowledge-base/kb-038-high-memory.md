# KB-038: Investigate Sustained High Memory Utilization
...
Provide a repeatable, auditable procedure to diagnose and resolve investigate sustained high memory utilization in the Contoso Systems Administration Lab.
...
- Available memory remains below 10%
- Paging and application latency increase
- A process working set grows continuously


## Likely causes

- Memory leak
- Oversized cache or workload
- Host or VM undersizing
...
```text
Get-Counter "\Memory\Pages/sec" -SampleInterval 5 -MaxSamples 12
```
...
- Available memory returns above threshold
- Paging drops to baseline
...
```text
INC-260838 — Investigate Sustained High Memory Utilization
...
Validation: Available memory returns above threshold; Paging drops to baseline.
