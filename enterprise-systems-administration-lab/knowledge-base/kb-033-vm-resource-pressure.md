# KB-033: Diagnose Virtual Machine Resource Pressure
...
Provide a repeatable, auditable procedure to diagnose and resolve virtual machine resource pressure in the Contoso Systems Administration Lab.
...
- VM latency or guest slowness
- Host CPU, memory, or storage contention
- Dynamic memory or CPU ready concerns
...
```text
Get-VM | Select Name,State,CPUUsage,MemoryAssigned,MemoryDemand
```
...
- No host saturation persists
- Capacity action is documented
