# KB-037: Investigate Sustained High CPU Utilization
...
Provide a repeatable, auditable procedure to diagnose and resolve investigate sustained high cpu utilization in the Contoso Systems Administration Lab.
...
- CPU remains above 85% for 15 minutes
- Applications become slow or unresponsive
- A process consumes abnormal CPU


## Likely causes

- Workload spike or runaway process
- Malware or failed update
- Insufficient capacity or inefficient query
...
- Business service latency normalizes
- Root cause or capacity follow-up is assigned
