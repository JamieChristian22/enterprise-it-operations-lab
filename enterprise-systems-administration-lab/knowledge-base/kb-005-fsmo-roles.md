# KB-005: Validate and Recover FSMO Role Availability
...
Provide a repeatable, auditable procedure to diagnose and resolve validate and fsmo role availability in the Contoso Systems Administration Lab.
...
- Domain operations fail during object creation or time synchronization
- Schema or domain changes fail
- The role holder is offline
...
- Role-holder outage
- Replication failure
- Improper demotion or metadata residue
...
- All five roles have reachable owners
- dcdiag passes on the new holder
- Replication converges after any transfer
