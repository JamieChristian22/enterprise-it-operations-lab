# KB-023: Correct Linux and Windows Time Drift
...
Provide a repeatable, auditable procedure to diagnose and resolve correct linux and windows time drift in the Contoso Systems Administration Lab.
...
- Server clocks differ by several minutes
- Monitoring reports unsynchronized time


## Likely causes

- Unreachable NTP source
- Incorrect hierarchy or configuration
- Virtualization time synchronization conflict
...
- Offset returns within 30 seconds
- The approved time source is listed
- Kerberos and scheduled operations work normally
