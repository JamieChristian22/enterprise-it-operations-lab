# KB-040: Perform a Privileged Access Review

| Field | Value |
|---|---|
| Service | Identity Governance |
| Audience | Systems Administrators / Security Analysts |
| Severity | Critical |
...
Provide a repeatable, auditable procedure to diagnose and resolve a privileged access review in the Contoso Systems Administration Lab.
...
- Quarterly access review is due
- Role change or termination occurred
- Audit requests proof of least privilege


## Likely causes

- Accumulated group membership
- Dormant privileged account
- Unapproved direct role assignment
...
```text
Get-MgDirectoryRoleMember -DirectoryRoleId 00000000-0000-0000-0000-000000000000
```
...
- Every privileged assignment has an owner and business justification
- Unneeded access is removed through change control
- Review evidence is retained for one year
