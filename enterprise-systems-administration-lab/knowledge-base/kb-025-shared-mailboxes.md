# KB-025: Configure and Troubleshoot Shared Mailboxes
...
Provide a repeatable, auditable procedure to diagnose and resolve configure and shared mailboxes in the Contoso Systems Administration Lab.
...
- Automapping is delayed or incorrect
...
```text
Get-MailboxPermission support@contoso.com
```
...
```text
Get-RecipientPermission support@contoso.com
```
...
```text
Add-MailboxPermission support@contoso.com -User jcarter@contoso.com -AccessRights FullAccess -AutoMapping $true
```
...
- Mailbox opens in Outlook on the web
- Approved sending permission works
- Permission is documented and least-privilege
...
```text
INC-260825 — Configure and Troubleshoot Shared Mailboxes
...
Validation: Mailbox opens in Outlook on the web; Approved sending permission works.
