# KB-012: Reset Windows Update Components Safely
...
Provide a repeatable, auditable procedure to diagnose and resolve windows update components safely in the Contoso Systems Administration Lab.
...
- Updates remain downloading or installing
- Windows Update reports repeated component errors
...
- BITS or cryptographic service issue
...
```text
Stop-Service BITS,wuauserv,cryptsvc -Force
```
...
- Required updates install successfully
- No pending reboot remains
