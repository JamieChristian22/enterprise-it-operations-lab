# KB-016: Respond to TLS Certificate Expiration

| Field | Value |
|---|---|
| Service | PKI / Security |
...
Provide a repeatable, auditable procedure to diagnose and resolve tls certificate expiration in the Contoso Systems Administration Lab.
...
- Browser or application reports an expired certificate
- Monitoring warns of fewer than 30 days remaining
- TLS handshake fails after renewal


## Likely causes

- Certificate was not renewed
- Wrong certificate binding
- Missing intermediate certificate or private key
...
```text
Get-ChildItem Cert:\LocalMachine\My | Sort NotAfter | Select Subject,Thumbprint,NotAfter
```
...
- Presented certificate has the correct subject and SANs
- Chain validation succeeds
- Expiration monitoring reflects the renewed date
