# KB-028: Troubleshoot OneDrive Synchronization
...
Provide a repeatable, auditable procedure to diagnose and resolve onedrive synchronization in the Contoso Systems Administration Lab.
...
- Files remain pending or show red X icons
- OneDrive reports a sync conflict
- Known Folder Move fails


## Likely causes

- Invalid filename/path length
- Account, storage, or permissions problem
- Corrupt client cache or unsupported file type
...
```text
Get-MgUserDrive -UserId jcarter@contoso.com
```
...
- Test file syncs in both directions
- No unresolved sync errors remain
- User storage is below quota
